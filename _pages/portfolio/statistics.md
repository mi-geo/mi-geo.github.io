...
They are especially useful when research subjects naturally fall into organizational/nested layers.
...
- educational outcomes across schools and classrooms (this is the most classical application of multilevel model)
...
...
<figure>
  <img src="/assets/images/res/AffordableCuisineandPopDen.png" alt="Where are the restuarants in Beijing?" style="width:60%;">
  <figcaption><small>Where are the restuarants in Beijing? (red: affordable, black: fine/luxury)</small><br>
...
You may observe some interesting patterns (or not?) from this five year surviving rate map:
...
Other common tools I use or I might use:
...
### Trivia: Time series comparasion: Shanghai vs. Urumqi

Air quality varies dramatically across China’s regions due to differences in climate, industrial structure, energy sources, and topography.  
Shanghai and Urumqi present a particularly sharp contrast:

- **Shanghai**  
<figure>
  <img src="/assets/images/res/Shanghai.png" alt="AQI Shanghai" style="width:100%;">
  <figcaption><small>AQI in Shanghai from 2001 to 2011</small></figcaption>
</figure>
  - Coastal, humid climate with strong atmospheric circulation  
  - Industrial but with diversified economy and cleaner energy  
  - Typically *moderate* AQI with seasonal fluctuations  

- **Urumqi**
<figure>
  <img src="/assets/images/res/Urumqi.png" alt="AQI Urumqi" style="width:100%;">
  <figcaption><small>AQI in Urumqi from 2001 to 2011</small></figcaption>
</figure>
  - Inland basin city surrounded by mountains  
  - Limited airflow and temperature inversions trap pollutants  
  - Heavy reliance on coal-based energy  
  - Consistently *higher* AQI, especially in winter


Environmental inequality emerges through geography and local energy systems—a theme that parallels disparities seen in legal deserts or violence diffusion.
